            ...
            <div class="card">
                <div class="card-body">
                    <form class="col-xl-12 col-lg-12 col-md-12" action="{{ route('submitAccount') }}" method="POST" enctype="multipart/form-data" id="userForm">
                        @csrf
                        <input type="hidden" name="id_internship" class="form-control" id="id" readonly>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="nik" value="" class="form-control" id="exampleInputNik1" oninput="validateNikLength(this)" aria-describedby="nikHelp" maxlength="16" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="exampleInputPosisi1" class="form-label">Asal Instansi</label>
                                <input type="text" name="asal_instansi" class="form-control" id="exampleInputPosisi1" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="foto_internship" class="form-control" id="exampleInputFoto1" onchange="previewImage(event)" required>
                            </div>
                        </div>
