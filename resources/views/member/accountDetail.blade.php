...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data Diri Internship Anda</h5>
            <div class="card">
                <div class="card-body">
                    @foreach($detailAccount as $data)
                        <form class="col-xl-12 col-lg-12 col-md-12" action="{{ route('updateAccount') }}" method="POST" enctype="multipart/form-data" id="userForm">
                            @csrf
                            <input type="hidden" value="{{ $data -> id_internship }}" name="id_internship" class="form-control" id="id" readonly>

                            <div class="row mb-3 justify-content-center">
                                <div class="col-md-6 text-center">
                                    <img class="img-fluid" width="200x" height="200x" src="{{ url('storage/foto_internship/' . $data->foto_internship) }}" alt="Foto Internship">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" value="{{ Auth::user() -> email }}" name="email" class="form-control" id="exampleInputEmail1" readonly>
                                </div>
                            </div>
                    ...
                    @endforeach
                    <form class="col-xl-12 col-lg-12 col-md-12" action="{{ route('updateFotoAccount') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach($detailAccount as $data)
                            <div class="col-md-6">
                            ...
                            <div class="d-flex justify-content-end">
                                <a class="btn btn-danger me-2" href="{{ route('mbIndex') }}">Kembali</a>
