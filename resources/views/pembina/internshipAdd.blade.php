...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Tambah Data Internship</h5>
            <div class="card">
                <div class="card-body">
                    <form class="col-xl-12 col-lg-12 col-md-12" action="{{ route('pbSubmitInternship') }}" method="POST" enctype="multipart/form-data" id="userForm">
                        @csrf
